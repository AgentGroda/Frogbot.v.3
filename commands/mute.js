...
module.exports.run = async (client, message, args) => {
  ...
  let log = db.fetch(`modlog__${message.guild.id}`)

  if (!message.guild.channels.get(log)) return message.channel.send('**Plese set a mod-log channel using =setmodlog**')
  const modlog = message.guild.channels.get(log)
